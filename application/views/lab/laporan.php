...
<body style="margin-top: 250px;">
	<div id="bigWrapper">
		...
		<div class="content" style="margin: 0 auto; width: 100%;">
			<p style="margin-top: 50px; width: 100%; font-weight: bold; font-size: 18px; text-align: center; margin-bottom: 30px;">Laporan Proses Koagulasi</p>
