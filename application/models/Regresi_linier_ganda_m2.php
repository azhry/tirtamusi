<?php 
class Regresi_linier_ganda_m2 extends MY_Model 
{
 private $variables;
 private $response;
 private $predictor;
 ...
 public function set_variables($variables)
 {
  ...
  $this->num_rows = $this->db->get('rata_rata_revisi')->num_rows();
 ...
 public function get_b1()
 {
  ...
  // echo 'sum x2^2: ' . $this->fixed_sum_pred2() . '<br>';
  // echo 'sum x1y: ' . $this->fixed_sum_product_pred1_res() . '<br>';
  // echo 'sum x2y: ' . $this->fixed_sum_product_pred2_res() . '<br>';
  // echo 'sum x1x2: ' . $this->fixed_sum_product_pred1_pred2() . '<br>';
 ...
 public function RMSE() {
  return sqrt(($this->sum_res_squared() - ($this->get_a() * $this->sum_res()) - ($this->get_b1() * $this->sum_product_pred1_res()) - ($this->get_b2() * $this->sum_product_pred2_res())) / ($this->num_rows - 3));
 }
}